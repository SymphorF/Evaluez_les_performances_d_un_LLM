...
CREATE TABLE "analyse_saison_NBA" (
  "Code" varchar,
  "Nom_complet_de_l_equipe" varchar,
...
CREATE TABLE "analyse_une_equipe" (
  "Player" varchar,
  "SUM_of_OREB" int,
  "SUM_of_DREB" int,
  "SUM_of_PIE" float,
...
CREATE TABLE "analyse_top_15_joueurs_points" (
  "Players" varchar,
...
ALTER TABLE "Analyse_d_une_equipe" ADD FOREIGN KEY ("Player") REFERENCES "players_stats" ("Player");

ALTER TABLE "Analyse_du_top_15_des_joueurs_en_nombre_de_points" ADD FOREIGN KEY ("Players") REFERENCES "players_stats" ("Player");
